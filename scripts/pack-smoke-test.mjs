...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      "import type { DominantColorOptions, DominantColorResult, DominantColorSource } from '@rtcoder/dominant-color';",
      '',
      ...
      '};',
      '',
      "async function run(source: DominantColorSource): Promise<DominantColorResult> {",
      '  return getDominantColorAsync(source, options);',
      '}',
      '',
      'void run;',
      '',
